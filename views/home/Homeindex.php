        ...
        <header class="primary-header">
            <div class="pl-5 pr-5">
                <div class="nav-wrapper">
                    ...
                    <nav class="primary-navigation display-sm-none" id="primary-navigation">
                    ...
                    <a href="/login" role="button" class="btn | display-sm-none">Log In</a>
                </div>
            </div>
        </header>
        ...
        <section class="hero-section">
            <div class="container">
                <div class="flow | text-center-sm-only hero">
                    ...
                    <a href="/register" role="button" class="btn">Get Started</a>
    ...
    <section class="introduction | padding-block-900" id="about">
        <div class="container about-container d-flex">
                ...
                <div class="about-img-container display-sm-none">
                    <img src="images/program-img1.jpg" alt="" class="introduction-img">
                </div>
        </div>
    </section>
    ...
    <section class="pricing | padding-block-900" id="pricing-section">
        <div class="container">
            ...
            <div class="plans padding-block-700 items-wrapper">
                ...
                <div class="plan-item bg-secondary">
                    <h5 class="fs-700 fw-semi-bold pricing-type">Membership</span></h5>
